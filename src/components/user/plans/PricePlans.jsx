    ...
    <div>
      <div className="flex flex-col items-center justify-between xl:flex-row">
        <div className="my-2 md:my-5">
          <h4 className="text-base leading-6.75 font-semibold text-[#414141] lg:text-lg">
            My Subscription Plans
          </h4>
          <p className="text-primary text-sm leading-6.75 lg:text-base">Manage Your Plans</p>
        </div>
