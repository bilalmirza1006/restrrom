// import '/images/default/header-bg.png' from '/images/default/header-bg.png';
...
const historyTableStyles = {
  ...
  rows: {
    style: {
      ...
      margin: '10px 0',
      borderBottomWidth: '0 !important',
      boxShadow: '0px 2px 4px 0px #00000040', // ✅ shadow added
    },
  },
...
export const planCardsData = [
  {
    ...
    stripePriceId: 'price_1RtRrdIvRUTQBOxaElD7rMOr', // replace with Stripe monthly price ID
    featuresList: [
      'Manage up to 3 buildings',
      'Connect up to 10 sensors',
      'Basic real-time monitoring',
  ...
  },
  {
    ...
    stripePriceId: 'price_1RtSKmIvRUTQBOxahzPBw0WH', // replace with Stripe yearly price ID
    featuresList: [
      'Manage up to 3 buildings',
      'Connect up to 10 sensors',
      'Basic real-time monitoring',
...
export const reportsLists = [
  {
    ...
    totalSensors: '110',
    image: '/images/default/header-bg.png',
    listData: [
      {
